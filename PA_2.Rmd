---
title: "Severe Weather Event Damage Analysis"
author: "Brian Linn"
...
```{r dataMean, echo = TRUE, results = "hide"}
dataMean <- mean(is.na(data))
```
Since the frequency of missing data for all the data is low, `r dataMean`, the  
...
```{r dataArrange, echo = TRUE, warning = FALSE, results = "hide"}
...
```{r finalData, echo = TRUE, warning = FALSE}
...
```{r convrtFun, echo = TRUE, warning = FALSE}
...
```{r finalData2, echo = TRUE, warning = FALSE}
